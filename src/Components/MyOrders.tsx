    ...
    return(
        <div className="w-full h-full flex justify-center">
            ...
            <div className="w-[80%] font-[Roboto]">
                ...
                <div className="flex flex-col justify-center gap-10 mt-5 min-h-[200px]">
                    {getMyOrder?.length?getMyOrder.map((book:any)=> 
                    ...
                    <div className="flex items-center font-bold"><li className="text-[#26A541] text-2xl"/>Order Placed on {orderDate}</div>
        </div>):<h1 className="text-xl">You have not Ordered Anything!</h1>}
                </div>
